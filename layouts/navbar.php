...
<nav class="navbar navbar-expand-lg navbar-dark bg-black">
    ...
    <a class="navbar-brand" href="index.php">LEGACYSHOP</a>
    </a>
        ...
        <div class="navbar-nav ml-auto">
            ...
            <?php }else{ ?>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-item nav-link active dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="far fa-address-book"></i> <?php echo $_SESSION['username']; ?>
                    </a>
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="/account"><i class="fas fa-user"></i> บัญชีของฉัน</a>
                    <a class="dropdown-item" href="/history_shop"><i class="fas fa-history"></i> ประวัติการซื้อสินค้า</a>
                    <a class="dropdown-item logout" href="#"><i class="fas fa-sign-out-alt"></i> ออกจากระบบ</a>
