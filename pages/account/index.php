...
<div class="container mt-3">
    <div class="row">
        <div class="col-sm-5 text-center">
            <div class="card">
                <div class="card-body">
                    <img src="https://media.discordapp.net/attachments/880780281735421972/1062720740312485938/users-icon.png?width=704&height=676" width="99px" class="rounded-circle">
                    <div class="mt-2">
